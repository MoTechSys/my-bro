...
> **أولوية المستخدم الأحدث — T-17/PR #22:** اقرأ `docs/INTENT_STUDY_AND_BLUEPRINT.md` مع STATE قبل متابعة التنفيذ. دراسة النية تميز الأصول عن قرارات الوكلاء؛ D1–D7 وADR-013 مقترحات تنتظر صاحب المشروع، ولا تعيد AI/الهواتف/واجهة جديدة إلى التنفيذ تلقائياً.
