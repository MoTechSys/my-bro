...
| 2 | `docs/00_PROJECT_STATE.md` | **الحالة الحالية بالضبط** — ما تم، ما المتبقي، آخر تحديث |
| 3 | `docs/03_ROADMAP.md` | الخطة الكاملة بالمراحل ومعايير القبول |
| 4 | `docs/04_ISSUES_LOG.md` | الأخطاء المكتشفة في المصادر + حالتها |
| 5 | `docs/02_ARCHITECTURE.md` | حقائق المعمل (IPs، الإصدارات، أسماء الوكلاء، معرّفات القواعد) |
| 6 | `docs/01_SOURCE_ANALYSIS.md` | التحليل العميق للمصادر السبعة التي رفعها المستخدم |
| 7 | `docs/DECISIONS.md` | القرارات المعمارية ولماذا اتُّخذت (ADR) |
