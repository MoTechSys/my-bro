...
- **المرحلة الحالية:** الفصول 1–5 مسودات موجودة، وحزمة Markdown/SVG منفذة؛ ليست نسخة جامعية معتمدة. القياس منفذ جزئيًا وفق الملخص الموحد، وما زال Windows source/controller وt4/t5 محليًا والقبول المعملي متبقيين. الهواتف خارج التنفيذ؛ AI داخل النطاق بـADR-014 واستشاري فقط، لا inference/C4 أصليان مثبتان.
