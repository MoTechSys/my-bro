...
نواة [T-70 / UC-14](docs/lab/UC-14_ai_analyst.md) موجودة في `ai_agent/analyst.py`: تعمل دون نموذج افتراضياً، وتصغّر البيانات وتتحقق من المراجع، وتتيح Ollama محلياً باختيار صريح. لا تنفذ استجابة، ولا تعني وجودها اكتمال RAG أو تشغيل نموذج أو نتائج C4. راجع الدليل للواجهة والقيود قبل الاستخدام.
