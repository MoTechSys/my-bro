...
> **تنبيه 2026-09-18:** جداول هذه الوثيقة تصف المعمل التاريخي ولقطاته، لا الجرد الحي للسحابة. أحدث جرد مسجل للسحابة في CLOUD_ENV_ACCESS بتاريخ2026-09-11 (Ubuntu endpoint وWazuh4.14.1) لم يُعد فحصه اليوم. OVA افتراض غيرمثبت؛ وAI ليس Future Work بعدADR-014 بل مكونقيدالتنفيذ. راجع ROADMAP وSTATE قبل أي نشر؛ ISSUE-045/076 مفتوحتان.
