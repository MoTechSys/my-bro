...
## ISSUE-102 — المخططات القديمة لا تطابق كود AR أوحدود الأدلة

الحالة: FIXED-IN-REPO جزئياً فينطاقالفصل3وحزمةالأشكال؛مراجعةبقيةالفصولوالمراجعمازالتOPEN. النسخةالقديمةرسمت rm -f وYARA recursion وحذفتFilebeat وافترضتتأكيدكلإجراءوتغطيةMITREللكل.886817e صححالنصوالثمانيةمخططات؛15 SVG ومصادرهاحاضرة.138a260 و3abb755 قوّياالنشرواتجاهاتالتدفقوقراءةالأزمنةبعدمراجعةbdb07323 وفحصبصري.36اختبارwriter/641 إجمالاًناجحةمحلياً؛لا قبولnative أوادعاءمخططSQL.تفصيلF1–F8وحدودالذريةوالتغطية فيWRITER_HANDOFF §10.
