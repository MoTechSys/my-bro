...
> **تنبيه تدقيق 2026-09-18:** هذا سجل التخطيط والاشتقاقات التاريخي. التنفيذ الحالي في [ROADMAP](03_ROADMAP.md) وTEST_PLAN v2 وADR-014: AI MUST، PILOT5 ثم≥30 وbaseline≥12h. لا تعتمد وصفAI خارجالنطاق أوالجرد/الميزانية أوادعاءV5 (unlink للـsymlink النهائي لا يحذفهدفه) كحقائقحالية؛ ISSUE-045/056/063/076 تظل للمراجعة. لا نغيّر النصوص التاريخية أو متطلبات المستخدم بصمت.
