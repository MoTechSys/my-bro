...
| T-10 | **خطة الاختبار المُقاس** (P2.1): بروتوكول لكل UC-01..08 — الخطوات، المتوقَّع، كيفية قياس MTTD/AR-latency/FP | ASTRA | 🟢 FREE (Astra أعلن نيّة الحجز 2026-09-09) | `tests/TEST_PLAN.md` | **لا** يُغلق ISSUE-019 وحده — الإغلاق يحتاج نتائج فعلية (T-11 + تنفيذ معملي). تصحيح من Astra |
