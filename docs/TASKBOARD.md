...
| T-11 | أداة قياس بسجل محاولات مستقل + تنبيهات + أدلة مصدر وmanifest للوقت والإعداد | ASTRA | IN-PROGRESS [ASTRA] 2026-09-09 — PR #20 نواة الكشف، 34 اختباراً محلياً | `scripts/measure/mttd.py`, اختبارات وعقد الإدخال | المتبقي: source adapters/manifest تحقق أدلة، AR/visibility/UC-01 متعدد المراحل، baseline وFP/hour، مراجعة مستقلة وPILOT؛ لا نتائج معملية |
