...
> **آخر تحقق: 2026-09-11 [AI]. ابدأ من §10 ثم §9 قبل أي تجربة.** مرشح المشرف منفذ باختبارات محلية وفاحص الصحة اختُبر سحابياً قراءة فقط؛ لم ينشر المشرف. توجد 19 عملية zombie مع خمس خدمات Wazuh حية وتقدم عدادات الجمع؛ ليس توقفاً كلياً مثبتاً. PID 1 هو `tail`، ولا init أو healthcheck أو restart policy أو mounts. إصلاح دورة الحياة وcanary والاستعادة بوابات مفتوحة؛ نتائج 2026-09-09 أدناه تاريخية وليست اعتماداً للحالة الحالية.
