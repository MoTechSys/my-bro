...
| 2 | الإطار النظري والدراسات السابقة | ❌ غير موجود | SOC، SIEM، IDS/NIDS، FIM، Active Response، Threat Intelligence (VirusTotal/YARA)، MITRE ATT&CK؛ مقارنة Wazuh vs OSSEC/ELK/Splunk/Security Onion؛ ≥10 مراجع (Wazuh docs، Suricata docs، NIST SP 800-61، MITRE) |
