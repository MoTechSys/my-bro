...
|-------|---------|:------:|------------------|
| 1 | المقدمة (1.1–1.11) | ✅ **v3 كامل** `deliverables/ch1/CH1_INTRODUCTION_FULL.md` (13 شكلاً: 7 متجهية SVG + 6 لقطات، 3 جداول، أسئلة بحثية، إضافة علمية C1–C4، تنظيم الرسالة) — حزمة `deliverables/ch1_thesis_package_2026-09-18.zip` لوكيل المستندات؛ v2 `ch1_introduction.md` محفوظة | نص S4 حرفياً + 9 تصحيحات مسجَّلة في §1.8؛ تُغلق ISSUE-001/002/003/015/027 على مستوى الرسالة |
