...
# All rights reserved.
#
# Wazuh Active Response - remove file flagged by VirusTotal (UC-03, Windows)
# Source: S2 pp.20-23 (Wazuh official PoC, transcribed from PDF - verify against the lab copy)
# Build:  pyinstaller -F remove-threat.py   -> dist\remove-threat.exe
# Deploy: C:\Program Files (x86)\ossec-agent\active-response\bin\remove-threat.exe
# WARNING: proof-of-concept script; review before production use.
